									            ...
									            jQuery(document).ready(function() {
									                ...
									                //redireccion a pagina del plantel
									               	jQuery("#state").on("change",function(){
									                	...
									                	jQuery.ajax({
												            type:"post",
												            url: "http://crm.interlingua.com.mx/crm/prospects/getRutaPlantel?plantel="+jQuery(this).val(),
			...
			<div id="metodo" class="metodo-full">
				<div class="metodo-interior wrap">
					...
					<div id="boton-metodo" class="fullcol clearfix" align="center">
						<button type="button" class="boton-metodo"  onclick="location.href='http://dev.clicker360.com/interlingua_sitio/nuestro-metodo/'">¡Conoce nuestro método!</button>
					</div>
			...
			<div id="cursos" class="cursos-full color1">
				<div class="cursos-interior wrap clearfix">
					...
					<div id="boton-cursos" class="fullcol clearfix" align="center">
						<button type="button" class="boton-cursos"  onclick="location.href='http://dev.clicker360.com/interlingua_sitio/cursosregulares/semi-intensivo/'">¡Inscríbete a uno de nuestros cursos!</button>
					</div>
			...
			<div id="test" class="test-full">
				<div class="test-interior wrap clearfix">
					...
					<div id="boton-test" class="fullcol clearfix" align="center">
						<button type="button" class="boton-test"  onclick="location.href='http://dev.clicker360.com/interlingua_sitio/?page_id=124'">¡Conoce tu nivel de inglés!</button>
					</div>
			...
			<div id="bolsa-trabajo" class="bolsa-trabajo-full">
				<div class="bolsa-trabajo-interior wrap clearfix">
					...
					<div class="subtitulo-seccion-bolsa-trabajo wrap clearfix">
						...
						<button type="button" class="boton-bolsa" onclick="location.href=' http://dev.clicker360.com/interlingua_sitio/bolsa-de-trabajo-2/'">Join us!</button>
					</div>
