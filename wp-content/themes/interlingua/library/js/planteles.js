...
var country_arr = new Array("Aguascalientes", "Campeche", "Coahuila", "Chihuaha", "Distrito Federal", "Estado De Mexico", "Guadalajara", "Guanajuato", "Hidalgo", "Morelia ", "Morelos", "Nuevo Leon", "Puebla", "Queretaro", "Quintana Roo", "San Luis Potosi", "Sinaloa", "Sonora", "Tabasco", "Veracruz", "Yucatan");
...
function print_country(country_id){
	...
	option_str.length=0;
	option_str.options[0] = new Option('Elige tu Estado','');
