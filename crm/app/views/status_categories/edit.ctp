<?php
    ...
    echo $this->Html->script('status_categories/edit', false);
?>
<div class="clientes form">

    <h2><?php __('Editar Categoria de Status');?></h2>
    ...
    <table cellspacing="0" cellpadding="5" class="table_form">
        <tr>
            <td>Nombre:</td>
            <td>
                <?php echo $form->input('StatusCategory.id',array('type'=>'hidden', 'class'=>'required')); ?>
