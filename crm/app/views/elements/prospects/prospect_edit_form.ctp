...
<?php
    ...
    $fields =array(
        ...
        array('id'=>'1','label'=>'Medio de contacto','model'=>'Prospect','keys'=>'medio_contacto','editable'=>true, 'options'=>array('id' => 'prospect_medio_publicidad', 'label' => false, 'type' => 'select', 'options' => array('CHAT'=>'Chat','EMAIL'=>'Email','LLAMADA'=>'Llamada'), 'empty' => 'Selecciona medio de contacto')),
