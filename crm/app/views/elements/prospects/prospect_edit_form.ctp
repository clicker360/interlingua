...
<?php
    ...
    $fields =array(
        ...
        array('id'=>'1','label'=>'Medio de contacto','model'=>'Prospect','keys'=>'medio_contacto','editable'=>true, 'options'=>array('type' => 'select', 'label' => false, 'id' => 'users_select', 'empty' => 'Seleccionar un usuario', 'multiple' => false, 'size' => 4,'options'=>"test")),
