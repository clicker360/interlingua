...
<?php
    ...
    $fields =array(
        ...
        array('id'=>'1','label'=>'Medio de contacto','model'=>'Prospect','keys'=>'medio_contacto','editable'=>true, 'options'=>array('id' => 'prospect_tipo_fecha', 'label' => false, 'type' => 'select', 'options' => array('Registro','Asignación','Última Atención'), 'empty' => 'Selecciona un Tipo de Fecha')),
