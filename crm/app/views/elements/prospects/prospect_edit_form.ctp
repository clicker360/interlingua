...
<?php
    ...
    $fields =array(
        ...
        array('id'=>'1','label'=>'Medio de contacto','model'=>'Prospect','keys'=>'medio_contacto','editable'=>true, 'options'=>array('label' => false, 'id' => 'status_category_select', 'options' => '<option value="CHAT">Chat</option><option value="EMAIL">Email</option><option value="LLAMADA">Llamada</option>', 'multiple' => false, 'size' => 3)),
