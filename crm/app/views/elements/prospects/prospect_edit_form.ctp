...
<?php
    ...
    $fields =array(
        ...
        array('id'=>'1','label'=>'Medio de contacto','model'=>'Prospect','keys'=>'medio_contacto','editable'=>true, 'options'=>array('label' => false, 'id' => 'status_category_select', 'options' => 'test', 'multiple' => true, 'size' => 4)),
